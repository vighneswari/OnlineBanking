...
var user_choice = window.confirm('welcome succesfully credited and you want to continue.....');
...
<body>
<body
	background="http://www.ecb-s.com/_data/123_deposit-system_offener_Schacht_JPG-1.jpg">
...
<%
CustomerBal data = new CustomerBal();
%>
	<div class="login">

<form method="GET" action="/depositController">

<%-- 
			<input type="hidden" name="key" id="key"
				value="<%=KeyFactory.keyToString(data.getKey())%>" />  --%>
				
	<input type="text" placeholder="AccountNumber" name="AccountNumber"><br>

			<input type="text" placeholder="Balance" name="Balance"><br>
			<input class="submit" type="submit" value="submit" onClick="foo()"/> 
